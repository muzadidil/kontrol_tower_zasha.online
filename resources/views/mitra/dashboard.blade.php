...
<div class="page-pad stack-3">
    ...
    @php
        ...
        $featureTiles = [
            ...
            ['withdraw',        'mitra.withdrawal',      'bi-bank',            'Tarik',     'Tarik dana',      'var(--mitra-blue-soft)', 'var(--mitra-blue-dark)'],
            ...
            ['maps',            'mitra.maps',            'bi-geo-alt-fill',    'Maps',      'Lokasi order',    'var(--mitra-blue-tint)', 'var(--mitra-blue)'],
        ];
