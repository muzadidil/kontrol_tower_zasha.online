        ...
        <div class="card-body">
            <form action="{{ route(\'login.submit\') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error(\'no_wa\') is-invalid @enderror" id="no_wa" name="no_wa" value="{{ old(\'no_wa\') }}" placeholder="Contoh: 81234567890" required autofocus>
                    @error(\'no_wa\')
